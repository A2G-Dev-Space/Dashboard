      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-2xl mb-6 border border-pastel-200 shadow-lg overflow-hidden">
            <img src="/logo.png" alt="Syngha's Portal" className="w-20 h-20 object-contain" />
          </div>
          <h1 className="text-3xl font-bold text-pastel-800 tracking-tight">Syngha's Portal</h1>
        ...
        <p className="text-center text-xs text-pastel-500 mt-8">
          &copy; 2026 Syngha's Portal. Samsung DS Internal Use Only.
        </p>
      </div>
    </div>
  );
