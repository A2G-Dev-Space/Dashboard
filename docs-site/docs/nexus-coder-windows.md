...
hero:
  ...
  actions:
    - theme: brand
      text: 다운로드 (v4.0.8)
      link: http://a2g.samsungds.net:13000/nexus-coder-for-windows/Nexus%20Coder%20(For%20Windows)-Setup-4.0.8.exe
    - theme: alt
      text: 사용 가이드
...
다운로드한 `Nexus Coder (For Windows)-Setup-4.0.8.exe`를 실행합니다.
