...
Nexus Coder for Windows 설치 및 시작 가이드입니다.
...
**[Nexus Coder (For Windows) Setup 4.0.8 다운로드](http://a2g.samsungds.net:13000/nexus-coder-for-windows/Nexus%20Coder%20(For%20Windows)-Setup-4.0.8.exe)** (~99MB)
...
1. 다운로드한 `Nexus Coder (For Windows)-Setup-4.0.8.exe` 실행
2. 설치 경로 선택 (기본값 권장)
3. **Install** 클릭
4. 설치 완료 후 **Run Nexus Coder** 체크하고 **Finish**

::: info 설치 경로
기본 설치 경로: `C:\Users\{사용자}\AppData\Local\Programs\Nexus Coder (For Windows)`
...
| 항목 | 경로 |
|------|------|
| 앱 실행 파일 | `C:\Users\{사용자}\AppData\Local\Programs\Nexus Coder (For Windows)\` |
...
::: tip 수동 업데이트
자동 업데이트가 동작하지 않으면 [다운로드 페이지](/nexus-coder-windows)에서 최신 버전을 직접 다운로드하여 설치하세요.
:::
