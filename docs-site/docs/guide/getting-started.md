...
# nexus-3.2.14.gz 다운로드
wget http://a2g.samsungds.net:13000/nexus-coder/cli/nexus-3.2.14.gz
...
::: tip wget 대신 curl 사용
```bash
curl -LO http://a2g.samsungds.net:13000/nexus-coder/cli/nexus-3.2.14.gz
...
```bash
# 압축 해제
gunzip nexus-3.2.14.gz

# 파일명 변경 및 실행 권한 부여
mv nexus-3.2.14 nexus
chmod +x nexus
```
