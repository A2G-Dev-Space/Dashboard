...
**[Nexus Bot Setup {{VERSION}} 다운로드](http://a2g.samsungds.net:13000/nexus-coder-for-windows/Nexus%20Bot%20(For%20Windows)-Setup-{{VERSION}}.exe)** (~99MB)
...
1. 다운로드한 `Nexus Bot (For Windows)-Setup-{{VERSION}}.exe` 실행
2. 설치 경로 선택 (기본값 권장)
3. **Install** 클릭
