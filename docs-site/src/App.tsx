...
function guideContentPath(path: string): string {
  ...
  const map: Record<string, string> = {
    ...
    '/guide/jira': 'guide/jira.md',
    '/guide/knox-messenger': 'guide/knox-messenger.md',
    '/guide/jarvis-memory': 'guide/jarvis-memory.md',
    ...
    '/guide-windows/knox-messenger': 'guide-windows/knox-messenger.md',
    '/guide-windows/jarvis-memory': 'guide-windows/jarvis-memory.md',
