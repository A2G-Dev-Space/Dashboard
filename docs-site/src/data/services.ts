...
export const services: ServiceInfo[] = [
  {
    ...
    features: [
      ...
      { icon: '📱', title: 'Knox Messenger 연동 (예정)', description: '모바일 Knox Messenger에서 Jarvis AI 비서에게 직접 업무를 지시할 수 있습니다.' },
      { icon: '🔍', title: 'Jira / Confluence 자동 연동', description: '사내 Jira 할당 이슈, Confluence 멘션 페이지를 자동으로 확인하고 알려줍니다.' },
      { icon: '🤖', title: 'Jarvis 자율 비서', description: '24시간 깨어있는 AI 비서가 TODO, 업무기록, Jira, Confluence를 주기적으로 체크합니다.' },
  ...
  },
  {
    ...
    status: 'stable',
    version: '5.1.2',
    downloadUrl: 'http://a2g.samsungds.net:13000/nexus-coder-for-windows/Nexus%20Bot%20(For%20Windows)-Setup-5.1.2.exe',
    features: [
      { icon: '💻', title: 'Native Windows', description: 'WSL 설치 없이 Windows 10/11에서 .exe로 바로 실행됩니다.' },
      { icon: '📱', title: 'Knox Messenger 연동 (예정)', description: '모바일 Knox Messenger에서 Jarvis AI 비서에게 업무를 지시할 수 있습니다.' },
      { icon: '🤖', title: 'Jarvis 자율 비서', description: 'Jira 할당 이슈, Confluence 멘션, FREE TODO를 주기적으로 확인하고 자율 실행합니다.' },
